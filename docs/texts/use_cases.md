...
- [Сценарий 4. Действия с аккаунтом.](#сценарий-4-действия-с-аккаунтом)
	...
	- [Сценарий 4.2. Приобретение статуса водителя.](#сценарий-42-приобретение-статуса-водителя)
	- [Сценарий 4.3. Заполнение данных об автомобиле.](#сценарий-43-заполнение-данных-об-автомобиле)
	- [Сценарий 4.4. Связь менеджера и водителя.](#сценарий-44-связь-менеджера-и-водителя)
		- [Сценарий 4.4.1. Добавление связи.](#сценарий-441-добавление-связи)
		- [Сценарий 4.4.2. Удаление связи.](#сценарий-442-удаление-связи)
	- [Сценарий 4.5. Фото.](#сценарий-45-фото)
...
Водитель нажимает "Опубликовать поездку". Защита от дурака - фрейм "Проверьте введённые данные". WordPress сохраняет изменения. Шлёт брокером сообщение на GeoService о создании поездки.
...
Водитель жмёт кнопу "Удалить поездку". Защита от дурака - фрейм "Укажите причину отмены". WordPress отмечает в своей БД поездку как удалённую. WordPress шлёт брокером на GeoService сообщение об отмене поездки. GeoService помечает поездку удалённой. WordPress сообщает юзеру об успешном удалении поездки.
...
Менеджер нажимает "Опубликовать поездку". Защита от дурака - фрейм "Проверьте введённые данные". WordPress сохраняет изменения. Шлёт брокером сообщение на GeoService о создании поездки.
...
Менеджер жмёт кнопу "Удалить поездку". Защита от дурака - фрейм "Укажите причину отмены". WordPress отмечает в своей БД поездку как удалённую. WordPress шлёт брокером на GeoService сообщение об отмене поездки. GeoService помечает поездку удалённой. WordPress сообщает юзеру об успешном удалении поездки.
...
При регистрации необходимо указать полное ФИО. Есть галочка "Скрывать настоящие данные" - в таком случае пассажирам отображаться должно лишь первых 3 символа фамилии (печально получится, если фамилия короче. Но пока забиваем на этот кейс), 3 звёздочки, инициалы и пол.
...
## Сценарий 4.2. Приобретение статуса водителя.
...
## Сценарий 4.3. Заполнение данных об автомобиле.
