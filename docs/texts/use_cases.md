	...
	- [Сценарий 3.1. Поездки для водителя.](#сценарий-31-поездки-для-водителя)
		- [Сценарий 3.1.1. Создание поездки.](#сценарий-311-создание-поездки)
			...
			- [Сценарий 3.1.1.3. Создание регулярной поездки, сохранение как шаблон.](#сценарий-3113-создание-регулярной-поездки-сохранение-как-шаблон)
				- [Сценарий 3.1.1.3.1. Редактирование перед публикацией шаблонной поездки.](#сценарий-31131-редактирование-перед-публикацией-шаблонной-поездки)
...
- водитель подтвердил право управлять транспортным средством.
...
- Водитель может начать планирование поездки даже если не подтвердил право управлять ТС или если есть пересечения времён. В таком случае WordPress показывает юзеру предупреждение. Сама поездка сохраняется в виде черновика. WordPress не даёт перевести статус в какой-либо другой (исключение - deleted).
...
##### Сценарий 3.1.1.3.1. Редактирование перед публикацией шаблонной поездки.
